...
INSERT IGNORE INTO today_mission (mission_id, condition_id, week_id, mission_date, recommended_intensity, recommended_time, recommended_zone, recommended_zone_desc, detail_comment, is_completed, is_rest, activity_id) VALUES
    (1, 1, 1, '2026-08-09', '권장 강도 | 중 · 고강도 러닝', '20분 내외로 도전해보세요.', 'Zone 3~4', '편안하게 대화할 수 있는 강도', '워밍업(5분)-메인(10분)-쿨다움(5분)', FALSE, FALSE, NULL);

# INSERT IGNORE INTO activity_record (record_id, user_id, running_duration, record_date, distance_m, avg_pace, avg_heart_rate, max_heart_rate, calories, cadence, start_time, end_time) VALUES
