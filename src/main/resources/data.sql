...
(2, '22222222-2222-2222-2222-222222222222', '달리기', 25, '여성', 168.0, 58.0, '꾸준히 달리고 있어요.'),
(3, '33333333-3333-3333-3333-333333333333', '뉴비러너', 28, '남성', 180.0, 75.0, '처음 시작해요.');
...
INSERT IGNORE INTO conditions (condition_id, user_id, condition_date, sleep_quality, body_condition, condition_title, condition_feedback, is_checked) VALUES
(1, 1, '2026-08-09', 'GOOD', 'GOOD', '최고의 컨디션이에요!', '["수면 7시간 이상, 폭 자서 개운해요.","최근 4일 운동 2회로 몸이 활기차요.","아픈 곳이 없어서 최상의 컨디션이에요."]', TRUE);

INSERT IGNORE INTO mission (mission_id, condition_id, week_id, mission_date, recommended_intensity, recommended_time, recommended_zone, recommended_zone_desc, detail_comment, is_completed, is_rest, activity_id) VALUES
...
INSERT IGNORE INTO skin_record (skin_id, user_id, type, measured_date, total_score, redness, oiliness, texture, pores, blemishes, hydration, pigment, skin_image) VALUES
(1, 1, 'AFTER_RUN', '2026-08-08', 78, 35, 42, 25, 30, 20, 65, 18, '/images/skin_001.jpg');

INSERT IGNORE INTO prescription (prescription_id, report_id, skin_id, prescription_date, category, title, summary, detail, is_completed, recommended_link, skin_result) VALUES
...
INSERT IGNORE INTO body_issue (user_id, body_part_code, is_painful) VALUES
(1, 'B_CALF_L', TRUE);

-- user2 데이터
INSERT IGNORE INTO future_goal (future_id, user_id, scene, target_distance, target_period, weekly_frequency, available_time, achievement_rate, created_at) VALUES
(2, 2, '5km를 쉬지 않고 완주하는 나', 10, 3, 3, 30, 0, '2026-08-09 09:00:00');

INSERT IGNORE INTO weekly_goal (week_id, user_id, future_id, week_no, weekly_goal, weekly_goal_distance, expected_calories, created_at) VALUES
(2, 2, 2, 1, '기초 체력 다지기', 15, 3500, '2026-08-09 09:00:00');
...
INSERT IGNORE INTO conditions (condition_id, user_id, condition_date, sleep_quality, body_condition, condition_title, condition_feedback, is_checked) VALUES
 (2, 2, '2026-08-11', 'FAIR', 'FAIR', '무난한 컨디션이에요.', '["수면 6시간으로 조금 부족해요.","최근 4일 운동 1회로 몸이 살짝 무거울 수 있어요.","무릎이 살짝 불편할 수 있어요."]', TRUE),
 (3, 2, '2026-08-13', 'GOOD', 'GOOD', '컨디션이 좋아졌어요!', '["수면 7시간으로 충분해요.","최근 4일 운동 2회로 몸이 활기차요.","아픈 곳이 없어요."]', TRUE);

INSERT IGNORE INTO activity_record (record_id, user_id, running_duration, record_date, distance_m, avg_pace, avg_heart_rate, max_heart_rate, calories, cadence, start_time, end_time, lat, lon) VALUES
(2, 2, 40, '2026-08-11', 6000, 400, 148, 170, 420, 165, '2026-08-11 07:00:00', '2026-08-11 07:40:00', 37.5665, 126.9780),
(3, 2, 35, '2026-08-13', 5500, 380, 150, 172, 390, 163, '2026-08-13 08:00:00', '2026-08-13 08:35:00', 37.5665, 126.9780);

INSERT IGNORE INTO mission (mission_id, condition_id, week_id, mission_date, recommended_intensity, recommended_time, recommended_zone, recommended_zone_desc, detail_comment, is_completed, is_rest, activity_id) VALUES
(2, 2, 2, '2026-08-11', '중강도 러닝', '30분 내외로 도전해보세요.', 'Zone 3', '조금 숨이 차는 정도', '워밍업(5분)-메인(20분)-쿨다운(5분)', TRUE, FALSE, 2),
(3, 3, 2, '2026-08-13', '저강도 조깅', '35분 내외로 도전해보세요.', 'Zone 2', '편안하게 대화할 수 있는 강도', '워밍업(5분)-메인(25분)-쿨다운(5분)', TRUE, FALSE, 3);

INSERT IGNORE INTO wellness_report (report_id, record_id, report_date, warning_title, running_intensity) VALUES
(2, 2, '2026-08-11', '페이스 조절이 필요해요', 6),
(3, 3, '2026-08-13', '좋은 러닝이었어요', 5);

INSERT IGNORE INTO skin_record (skin_id, user_id, type, measured_date, total_score, redness, oiliness, texture, pores, blemishes, hydration, pigment, skin_image) VALUES
(2, 2, 'AFTER_RUN', '2026-08-11', 72, 40, 38, 28, 32, 22, 60, 20, '/images/skin_002.jpg'),
(3, 2, 'AFTER_CARE', '2026-08-13', 80, 30, 35, 22, 28, 18, 70, 15, '/images/skin_003.jpg');

INSERT IGNORE INTO prescription (prescription_id, report_id, skin_id, prescription_date, category, title, summary, detail, is_completed, recommended_link, skin_result) VALUES
(4, 2, 2, '2026-08-11', 'STRETCH', '무릎이 불편해요.', '무릎 주변 근육을 스트레칭해주세요.', NULL, TRUE, NULL, NULL),
(5, 2, 2, '2026-08-11', 'SKIN', '러닝 후 피부 열감이 있어요.', '쿨링 세안을 추천드려요.', NULL, FALSE, NULL, '열감이 있어요'),
(6, 3, 3, '2026-08-13', 'STRETCH', '종아리가 뭉쳤어요.', '종아리 스트레칭을 추천드려요.', NULL, TRUE, NULL, NULL),
(7, 3, 3, '2026-08-13', 'SKIN', '피부가 건조해요.', '수분 보충 세럼을 추천드려요.', NULL, TRUE, NULL, '건조함이 느껴져요');
